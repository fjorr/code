      ...
      <div className="flex flex-col division-list">
        {publishedItems.map((item) => (
          <Link
            ...
            className="flex items-center justify-between py-3 border-b border-white/5 hover:bg-white/5 px-2 rounded-[6px] transition-all duration-200 group cursor-pointer"
          >
