...
export default function FeatureRail({ film }: FeatureRailProps) {
  ...
  return (
    // 🌟 STEP 1: Outer layout padding acts as a gutter buffer so card edges never hit mobile glass rims
    <section className="w-full px-8 md:px-16">
      
      {/* 🌟 STEP 2: Max-width container caps the layout width on 4K/wide monitors and centers it */}
      <div className="w-full max-w-[1440px] mx-auto">
        
      <Link 
          href={`/film/${film.slug}`}
          // 🎯 THE FIX: Drop mobile top padding to pt-16 (64px) and use md:pt-32 (128px) for desktop
          className="w-full intent-card block aspect-[1/1.618] md:aspect-[4/3] lg:aspect-[16/9] flex flex-col justify-end px-8 md:px-10 pb-10 pt-16 md:pt-32 relative overflow-hidden rounded-[12px] bg-cover bg-center transition-all duration-500 group cursor-pointer"
          style={{
