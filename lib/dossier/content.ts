...
export type DossierBlock =
  ...
  | { type: 'timeline'; items: DossierTimelineItem[] }
  | {
      type: 'figure';
      src: string;
      alt: string;
      width: number;
      height: number;
      /** Optional credit / punchline under the image */
      caption?: string;
    };
...
export const DOSSIER_ARTICLES: DossierArticle[] = [
  {
    ...
    dek: "The dark arts of the internet aren't inevitable. They're just profitable.",
    ref: 'FJR-DOS-001',
    readMinutes: 5,
    poster: '/dossier/the-internet-doesnt-have-to-be-this-way.avif',
    paragraphs: [
      "Ads that follow you from one screen to the next, built on data quietly collected from everywhere you've been. Algorithms that decide what you see before you ever ask for it — your attention sold to advertisers in an auction that happens before the page even loads. Feeds with no end, because an end would mean you might leave. Headlines built to make you angry enough to click, because outrage spreads faster than almost anything true. Interfaces built with the dark arts of UI design. And now, an entire layer of content nobody actually made, generated at a scale no human ever could, filling the space where something true used to be.",
      "None of it is an accident. It has a name — the attention economy — and a business model that only works if you stay.",
      "Most people will tell you the same thing: they don't trust what they read anymore, they can't remember what they watched, and they're tired in a way that has nothing to do with sleep.",
      ...
      "It's the Bureaux — members who fund the work directly, so the business model never has to become the thing we're trying to avoid. We're betting people are tired of being the product.",
    ],
    footnotes: [
      {
        id: '1',
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: 'figure',
        src: 'https://media.fjorr.com/assets/fjorr-le-voyage-dans-la-lune.jpg',
  ...
  },
  {
    ...
    slug: 'plus-machine',
    title: 'Plus Machine',
    dek: 'Nothing here is version final. Everything can be made more.',
    ref: 'FJR-DOS-003',
    readMinutes: 4,
    ...
    body: [
      {
        type: 'p',
        text: "A film that ships once and is never touched again isn't a myth — it's a snapshot. The stories that became myths didn't survive by accident. Someone kept choosing to tell them again — whether that story is a thousand years old, happened last year, or is being told here for the very first time. They were shaped, again and again, by the people who cared enough to make them better.",
      },
      {
        type: 'p',
        text: "Most media doesn't work this way. A film releases, and that's it — whatever's wrong with it is wrong forever. A mistake made on day one is a mistake made for the life of the work. That's not how a story earns myth status, and it's not how Fjorr works either.",
      },
      {
        type: 'p',
        text: "Every film on Fjorr ships as v1 — not a rough draft, not the final word. If something's not landing, the people watching can say so. If the people who made it agree, they fix it — or sometimes, someone else does. A stronger cut, a different score, a swing nobody working on it thought to take. If it's better, and the people who made the film agree, it ships, credited to whoever made it better. Not because the first version failed, but because better was always still possible.",
      },
      {
        type: 'figure',
        src: 'https://media.fjorr.com/assets/fjorr-plus-machine.avif',
        alt: 'The Plus Machine — propose a better cut, score, or swing for a film on Fjorr.',
        width: 728,
        height: 896,
      },
      {
        type: 'p',
        text: "This isn't a comment section. It's not a review score. It's a direct line between the audience that felt something was missing and the people with the authority to do something about it. The credit stays. The history stays. Nothing gets erased — it gets versioned, the same way any story that survives accumulates its retellings instead of discarding the ones that came before.",
      },
      {
        type: 'p',
        text: "We call this the Plus Machine, because that's the whole idea in two words.",
      },
    ],
  },
];
